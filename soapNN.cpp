...
//      phi(a,r) = pow(rcut - GL(r,0), 2*(a + 3))/N(a); // not rescaled
  ...
  for(int r=0; r < GL.n_rows; r++){ 
    for(int n=0; n < N.n_rows; n++){ 
      for(int a=0; a < W.n_rows; a++){ 
        g(n,r) = g(n,r) + W(n,a)*phi(a,r); // DO I NEED TO RESCALE W???
      }
    }
  }
  ...
  //    Y0(t,p) = tesseral_spherical_harm(0,0,GL(t,0),GL(p,0)); // not rescaled.
      Y0(t,p) = tesseral_spherical_harm(0,0,Theta(t),Phi(p)); // rescaled
      }
    }
  ...
  double C000 = integrate3D(rho,T000,R,Theta,Phi);    double C100 = integrate3D(rho,T100,R,Theta,Phi);  double C200 = integrate3D(rho,T200,R,Theta,Phi);
  double C01m1 = integrate3D(rho,T01m1,R,Theta,Phi);  double C11m1 = integrate3D(rho,T11m1,R,Theta,Phi);  double C21m1 = integrate3D(rho,T21m1,R,Theta,Phi);
  double C010  = integrate3D(rho,T010,R,Theta,Phi);   double C110  = integrate3D(rho,T110,R,Theta,Phi);  double C210  = integrate3D(rho,T210,R,Theta,Phi);
  double C01p1 = integrate3D(rho,T01p1,R,Theta,Phi);  double C11p1 = integrate3D(rho,T11p1,R,Theta,Phi);  double C21p1 = integrate3D(rho,T21p1,R,Theta,Phi);
  double C02m2 = integrate3D(rho,T02m2,R,Theta,Phi);  double C12m2 = integrate3D(rho,T12m2,R,Theta,Phi);  double C22m2 = integrate3D(rho,T22m2,R,Theta,Phi);
  double C02m1 = integrate3D(rho,T02m1,R,Theta,Phi);  double C12m1 = integrate3D(rho,T12m1,R,Theta,Phi);  double C22m1 = integrate3D(rho,T22m1,R,Theta,Phi);
  double C020  = integrate3D(rho,T020,R,Theta,Phi);   double C120  = integrate3D(rho,T120,R,Theta,Phi);  double C220  = integrate3D(rho,T220,R,Theta,Phi);
  double C02p1 = integrate3D(rho,T02p1,R,Theta,Phi);  double C12p1 = integrate3D(rho,T12p1,R,Theta,Phi);  double C22p1 = integrate3D(rho,T22p1,R,Theta,Phi);
  double C02p2 = integrate3D(rho,T02p2,R,Theta,Phi);  double C12p2 = integrate3D(rho,T12p2,R,Theta,Phi);  double C22p2 = integrate3D(rho,T22p2,R,Theta,Phi);
  double C03m3 = integrate3D(rho,T03m3,R,Theta,Phi);  double C13m3 = integrate3D(rho,T13m3,R,Theta,Phi);  double C23m3 = integrate3D(rho,T23m3,R,Theta,Phi);
  double C03m2 = integrate3D(rho,T03m2,R,Theta,Phi);  double C13m2 = integrate3D(rho,T13m2,R,Theta,Phi);  double C23m2 = integrate3D(rho,T23m2,R,Theta,Phi);
  double C03m1 = integrate3D(rho,T03m1,R,Theta,Phi);  double C13m1 = integrate3D(rho,T13m1,R,Theta,Phi);  double C23m1 = integrate3D(rho,T23m1,R,Theta,Phi);
  double C030  = integrate3D(rho,T030,R,Theta,Phi);   double C130  = integrate3D(rho,T130,R,Theta,Phi);  double C230  = integrate3D(rho,T230,R,Theta,Phi);
  double C03p1 = integrate3D(rho,T03p1,R,Theta,Phi);  double C13p1 = integrate3D(rho,T13p1,R,Theta,Phi);  double C23p1 = integrate3D(rho,T23p1,R,Theta,Phi);
  double C03p2 = integrate3D(rho,T03p2,R,Theta,Phi);  double C13p2 = integrate3D(rho,T13p2,R,Theta,Phi);  double C23p2 = integrate3D(rho,T23p2,R,Theta,Phi);
  double C03p3 = integrate3D(rho,T03p3,R,Theta,Phi);  double C13p3 = integrate3D(rho,T13p3,R,Theta,Phi);  double C23p3 = integrate3D(rho,T23p3,R,Theta,Phi);
  double C04m4 = integrate3D(rho,T04m4,R,Theta,Phi);  double C14m4 = integrate3D(rho,T14m4,R,Theta,Phi);  double C24m4 = integrate3D(rho,T24m4,R,Theta,Phi);
  double C04m3 = integrate3D(rho,T04m3,R,Theta,Phi);  double C14m3 = integrate3D(rho,T14m3,R,Theta,Phi);  double C24m3 = integrate3D(rho,T24m3,R,Theta,Phi);
  double C04m2 = integrate3D(rho,T04m2,R,Theta,Phi);  double C14m2 = integrate3D(rho,T14m2,R,Theta,Phi);  double C24m2 = integrate3D(rho,T24m2,R,Theta,Phi);
  double C04m1 = integrate3D(rho,T04m1,R,Theta,Phi);  double C14m1 = integrate3D(rho,T14m1,R,Theta,Phi);  double C24m1 = integrate3D(rho,T24m1,R,Theta,Phi);
  double C040  = integrate3D(rho,T040,R,Theta,Phi);   double C140  = integrate3D(rho,T140,R,Theta,Phi);  double C240  = integrate3D(rho,T240,R,Theta,Phi);
  double C04p1 = integrate3D(rho,T04p1,R,Theta,Phi);  double C14p1 = integrate3D(rho,T14p1,R,Theta,Phi);  double C24p1 = integrate3D(rho,T24p1,R,Theta,Phi);
  double C04p2 = integrate3D(rho,T04p2,R,Theta,Phi);  double C14p2 = integrate3D(rho,T14p2,R,Theta,Phi);  double C24p2 = integrate3D(rho,T24p2,R,Theta,Phi);
  double C04p3 = integrate3D(rho,T04p3,R,Theta,Phi);  double C14p3 = integrate3D(rho,T14p3,R,Theta,Phi);  double C24p3 = integrate3D(rho,T24p3,R,Theta,Phi);
  double C04p4 = integrate3D(rho,T04p4,R,Theta,Phi);  double C14p4 = integrate3D(rho,T14p4,R,Theta,Phi);  double C24p4 = integrate3D(rho,T24p4,R,Theta,Phi);
  double C05m5 = integrate3D(rho,T05m5,R,Theta,Phi);  double C15m5 = integrate3D(rho,T15m5,R,Theta,Phi);  double C25m5 = integrate3D(rho,T25m5,R,Theta,Phi);
  double C05m4 = integrate3D(rho,T05m4,R,Theta,Phi);  double C15m4 = integrate3D(rho,T15m4,R,Theta,Phi);  double C25m4 = integrate3D(rho,T25m4,R,Theta,Phi);
  double C05m3 = integrate3D(rho,T05m3,R,Theta,Phi);  double C15m3 = integrate3D(rho,T15m3,R,Theta,Phi);  double C25m3 = integrate3D(rho,T25m3,R,Theta,Phi);
  double C05m2 = integrate3D(rho,T05m2,R,Theta,Phi);  double C15m2 = integrate3D(rho,T15m2,R,Theta,Phi);  double C25m2 = integrate3D(rho,T25m2,R,Theta,Phi);
  double C05m1 = integrate3D(rho,T05m1,R,Theta,Phi);  double C15m1 = integrate3D(rho,T15m1,R,Theta,Phi);  double C25m1 = integrate3D(rho,T25m1,R,Theta,Phi);
  double C050  = integrate3D(rho,T050,R,Theta,Phi);   double C150  = integrate3D(rho,T150,R,Theta,Phi);  double C250  = integrate3D(rho,T250,R,Theta,Phi);
  double C05p1 = integrate3D(rho,T05p1,R,Theta,Phi);  double C15p1 = integrate3D(rho,T15p1,R,Theta,Phi);  double C25p1 = integrate3D(rho,T25p1,R,Theta,Phi);
  double C05p2 = integrate3D(rho,T05p2,R,Theta,Phi);  double C15p2 = integrate3D(rho,T15p2,R,Theta,Phi);  double C25p2 = integrate3D(rho,T25p2,R,Theta,Phi);
  double C05p3 = integrate3D(rho,T05p3,R,Theta,Phi);  double C15p3 = integrate3D(rho,T15p3,R,Theta,Phi);  double C25p3 = integrate3D(rho,T25p3,R,Theta,Phi);
  double C05p4 = integrate3D(rho,T05p4,R,Theta,Phi);  double C15p4 = integrate3D(rho,T15p4,R,Theta,Phi);  double C25p4 = integrate3D(rho,T25p4,R,Theta,Phi);
  double C05p5 = integrate3D(rho,T05p5,R,Theta,Phi);  double C15p5 = integrate3D(rho,T15p5,R,Theta,Phi);  double C25p5 = integrate3D(rho,T25p5,R,Theta,Phi);
  double C06m6 = integrate3D(rho,T06m6,R,Theta,Phi);  double C16m6 = integrate3D(rho,T16m6,R,Theta,Phi);  double C26m6 = integrate3D(rho,T26m6,R,Theta,Phi);
  double C06m5 = integrate3D(rho,T06m5,R,Theta,Phi);  double C16m5 = integrate3D(rho,T16m5,R,Theta,Phi);  double C26m5 = integrate3D(rho,T26m5,R,Theta,Phi);
  double C06m4 = integrate3D(rho,T06m4,R,Theta,Phi);  double C16m4 = integrate3D(rho,T16m4,R,Theta,Phi);  double C26m4 = integrate3D(rho,T26m4,R,Theta,Phi);
  double C06m3 = integrate3D(rho,T06m3,R,Theta,Phi);  double C16m3 = integrate3D(rho,T16m3,R,Theta,Phi);  double C26m3 = integrate3D(rho,T26m3,R,Theta,Phi);
  double C06m2 = integrate3D(rho,T06m2,R,Theta,Phi);  double C16m2 = integrate3D(rho,T16m2,R,Theta,Phi);  double C26m2 = integrate3D(rho,T26m2,R,Theta,Phi);
  double C06m1 = integrate3D(rho,T06m1,R,Theta,Phi);  double C16m1 = integrate3D(rho,T16m1,R,Theta,Phi);  double C26m1 = integrate3D(rho,T26m1,R,Theta,Phi);
  double C060  = integrate3D(rho,T060,R,Theta,Phi);   double C160  = integrate3D(rho,T160,R,Theta,Phi);  double C260  = integrate3D(rho,T260,R,Theta,Phi);
  double C06p1 = integrate3D(rho,T06p1,R,Theta,Phi);  double C16p1 = integrate3D(rho,T16p1,R,Theta,Phi);  double C26p1 = integrate3D(rho,T26p1,R,Theta,Phi);
  double C06p2 = integrate3D(rho,T06p2,R,Theta,Phi);  double C16p2 = integrate3D(rho,T16p2,R,Theta,Phi);  double C26p2 = integrate3D(rho,T26p2,R,Theta,Phi);
  double C06p3 = integrate3D(rho,T06p3,R,Theta,Phi);  double C16p3 = integrate3D(rho,T16p3,R,Theta,Phi);  double C26p3 = integrate3D(rho,T26p3,R,Theta,Phi);
  double C06p4 = integrate3D(rho,T06p4,R,Theta,Phi);  double C16p4 = integrate3D(rho,T16p4,R,Theta,Phi);  double C26p4 = integrate3D(rho,T26p4,R,Theta,Phi);
  double C06p5 = integrate3D(rho,T06p5,R,Theta,Phi);  double C16p5 = integrate3D(rho,T16p5,R,Theta,Phi);  double C26p5 = integrate3D(rho,T26p5,R,Theta,Phi);
  double C06p6 = integrate3D(rho,T06p6,R,Theta,Phi);  double C16p6 = integrate3D(rho,T16p6,R,Theta,Phi);  double C26p6 = integrate3D(rho,T26p6,R,Theta,Phi);
  double C07m7 = integrate3D(rho,T07m7,R,Theta,Phi);  double C17m7 = integrate3D(rho,T17m7,R,Theta,Phi);  double C27m7 = integrate3D(rho,T27m7,R,Theta,Phi);
  double C07m6 = integrate3D(rho,T07m6,R,Theta,Phi);  double C17m6 = integrate3D(rho,T17m6,R,Theta,Phi);  double C27m6 = integrate3D(rho,T27m6,R,Theta,Phi);
  double C07m5 = integrate3D(rho,T07m5,R,Theta,Phi);  double C17m5 = integrate3D(rho,T17m5,R,Theta,Phi);  double C27m5 = integrate3D(rho,T27m5,R,Theta,Phi);
  double C07m4 = integrate3D(rho,T07m4,R,Theta,Phi);  double C17m4 = integrate3D(rho,T17m4,R,Theta,Phi);  double C27m4 = integrate3D(rho,T27m4,R,Theta,Phi);
  double C07m3 = integrate3D(rho,T07m3,R,Theta,Phi);  double C17m3 = integrate3D(rho,T17m3,R,Theta,Phi);  double C27m3 = integrate3D(rho,T27m3,R,Theta,Phi);
  double C07m2 = integrate3D(rho,T07m2,R,Theta,Phi);  double C17m2 = integrate3D(rho,T17m2,R,Theta,Phi);  double C27m2 = integrate3D(rho,T27m2,R,Theta,Phi);
  double C07m1 = integrate3D(rho,T07m1,R,Theta,Phi);  double C17m1 = integrate3D(rho,T17m1,R,Theta,Phi);  double C27m1 = integrate3D(rho,T27m1,R,Theta,Phi);
  double C070  = integrate3D(rho,T070,R,Theta,Phi);   double C170  = integrate3D(rho,T170,R,Theta,Phi);  double C270  = integrate3D(rho,T270,R,Theta,Phi);
  double C07p1 = integrate3D(rho,T07p1,R,Theta,Phi);  double C17p1 = integrate3D(rho,T17p1,R,Theta,Phi);  double C27p1 = integrate3D(rho,T27p1,R,Theta,Phi);
  double C07p2 = integrate3D(rho,T07p2,R,Theta,Phi);  double C17p2 = integrate3D(rho,T17p2,R,Theta,Phi);  double C27p2 = integrate3D(rho,T27p2,R,Theta,Phi);
  double C07p3 = integrate3D(rho,T07p3,R,Theta,Phi);  double C17p3 = integrate3D(rho,T17p3,R,Theta,Phi);  double C27p3 = integrate3D(rho,T27p3,R,Theta,Phi);
  double C07p4 = integrate3D(rho,T07p4,R,Theta,Phi);  double C17p4 = integrate3D(rho,T17p4,R,Theta,Phi);  double C27p4 = integrate3D(rho,T27p4,R,Theta,Phi);
  double C07p5 = integrate3D(rho,T07p5,R,Theta,Phi);  double C17p5 = integrate3D(rho,T17p5,R,Theta,Phi);  double C27p5 = integrate3D(rho,T27p5,R,Theta,Phi);
  double C07p6 = integrate3D(rho,T07p6,R,Theta,Phi);  double C17p6 = integrate3D(rho,T17p6,R,Theta,Phi);  double C27p6 = integrate3D(rho,T27p6,R,Theta,Phi);
  double C07p7 = integrate3D(rho,T07p7,R,Theta,Phi);  double C17p7 = integrate3D(rho,T17p7,R,Theta,Phi);  double C27p7 = integrate3D(rho,T27p7,R,Theta,Phi);
  double C08m8 = integrate3D(rho,T08m8,R,Theta,Phi);  double C18m8 = integrate3D(rho,T18m8,R,Theta,Phi);  double C28m8 = integrate3D(rho,T28m8,R,Theta,Phi);
  double C08m7 = integrate3D(rho,T08m7,R,Theta,Phi);  double C18m7 = integrate3D(rho,T18m7,R,Theta,Phi);  double C28m7 = integrate3D(rho,T28m7,R,Theta,Phi);
  double C08m6 = integrate3D(rho,T08m6,R,Theta,Phi);  double C18m6 = integrate3D(rho,T18m6,R,Theta,Phi);  double C28m6 = integrate3D(rho,T28m6,R,Theta,Phi);
  double C08m5 = integrate3D(rho,T08m5,R,Theta,Phi);  double C18m5 = integrate3D(rho,T18m5,R,Theta,Phi);  double C28m5 = integrate3D(rho,T28m5,R,Theta,Phi);
  double C08m4 = integrate3D(rho,T08m4,R,Theta,Phi);  double C18m4 = integrate3D(rho,T18m4,R,Theta,Phi);  double C28m4 = integrate3D(rho,T28m4,R,Theta,Phi);
  double C08m3 = integrate3D(rho,T08m3,R,Theta,Phi);  double C18m3 = integrate3D(rho,T18m3,R,Theta,Phi);  double C28m3 = integrate3D(rho,T28m3,R,Theta,Phi);
  double C08m2 = integrate3D(rho,T08m2,R,Theta,Phi);  double C18m2 = integrate3D(rho,T18m2,R,Theta,Phi);  double C28m2 = integrate3D(rho,T28m2,R,Theta,Phi);
  double C08m1 = integrate3D(rho,T08m1,R,Theta,Phi);  double C18m1 = integrate3D(rho,T18m1,R,Theta,Phi);  double C28m1 = integrate3D(rho,T28m1,R,Theta,Phi);
  double C080  = integrate3D(rho,T080,R,Theta,Phi);   double C180  = integrate3D(rho,T180,R,Theta,Phi);  double C280  = integrate3D(rho,T280,R,Theta,Phi);
  double C08p1 = integrate3D(rho,T08p1,R,Theta,Phi);  double C18p1 = integrate3D(rho,T18p1,R,Theta,Phi);  double C28p1 = integrate3D(rho,T28p1,R,Theta,Phi);
  double C08p2 = integrate3D(rho,T08p2,R,Theta,Phi);  double C18p2 = integrate3D(rho,T18p2,R,Theta,Phi);  double C28p2 = integrate3D(rho,T28p2,R,Theta,Phi);
  double C08p3 = integrate3D(rho,T08p3,R,Theta,Phi);  double C18p3 = integrate3D(rho,T18p3,R,Theta,Phi);  double C28p3 = integrate3D(rho,T28p3,R,Theta,Phi);
  double C08p4 = integrate3D(rho,T08p4,R,Theta,Phi);  double C18p4 = integrate3D(rho,T18p4,R,Theta,Phi);  double C28p4 = integrate3D(rho,T28p4,R,Theta,Phi);
  double C08p5 = integrate3D(rho,T08p5,R,Theta,Phi);  double C18p5 = integrate3D(rho,T18p5,R,Theta,Phi);  double C28p5 = integrate3D(rho,T28p5,R,Theta,Phi);
  double C08p6 = integrate3D(rho,T08p6,R,Theta,Phi);  double C18p6 = integrate3D(rho,T18p6,R,Theta,Phi);  double C28p6 = integrate3D(rho,T28p6,R,Theta,Phi);
  double C08p7 = integrate3D(rho,T08p7,R,Theta,Phi);  double C18p7 = integrate3D(rho,T18p7,R,Theta,Phi);  double C28p7 = integrate3D(rho,T28p7,R,Theta,Phi);
  double C08p8 = integrate3D(rho,T08p8,R,Theta,Phi);  double C18p8 = integrate3D(rho,T18p8,R,Theta,Phi);  double C28p8 = integrate3D(rho,T28p8,R,Theta,Phi);
  double C09m9 = integrate3D(rho,T09m9,R,Theta,Phi);  double C19m9 = integrate3D(rho,T19m9,R,Theta,Phi);  double C29m9 = integrate3D(rho,T29m9,R,Theta,Phi);
  double C09m8 = integrate3D(rho,T09m8,R,Theta,Phi);  double C19m8 = integrate3D(rho,T19m8,R,Theta,Phi);  double C29m8 = integrate3D(rho,T29m8,R,Theta,Phi);
  double C09m7 = integrate3D(rho,T09m7,R,Theta,Phi);  double C19m7 = integrate3D(rho,T19m7,R,Theta,Phi);  double C29m7 = integrate3D(rho,T29m7,R,Theta,Phi);
  double C09m6 = integrate3D(rho,T09m6,R,Theta,Phi);  double C19m6 = integrate3D(rho,T19m6,R,Theta,Phi);  double C29m6 = integrate3D(rho,T29m6,R,Theta,Phi);
  double C09m5 = integrate3D(rho,T09m5,R,Theta,Phi);  double C19m5 = integrate3D(rho,T19m5,R,Theta,Phi);  double C29m5 = integrate3D(rho,T29m5,R,Theta,Phi);
  double C09m4 = integrate3D(rho,T09m4,R,Theta,Phi);  double C19m4 = integrate3D(rho,T19m4,R,Theta,Phi);  double C29m4 = integrate3D(rho,T29m4,R,Theta,Phi);
  double C09m3 = integrate3D(rho,T09m3,R,Theta,Phi);  double C19m3 = integrate3D(rho,T19m3,R,Theta,Phi);  double C29m3 = integrate3D(rho,T29m3,R,Theta,Phi);
  double C09m2 = integrate3D(rho,T09m2,R,Theta,Phi);  double C19m2 = integrate3D(rho,T19m2,R,Theta,Phi);  double C29m2 = integrate3D(rho,T29m2,R,Theta,Phi);
  double C09m1 = integrate3D(rho,T09m1,R,Theta,Phi);  double C19m1 = integrate3D(rho,T19m1,R,Theta,Phi);  double C29m1 = integrate3D(rho,T29m1,R,Theta,Phi);
  double C090  = integrate3D(rho,T090,R,Theta,Phi);   double C190  = integrate3D(rho,T190,R,Theta,Phi);  double C290  = integrate3D(rho,T290,R,Theta,Phi);
  double C09p1 = integrate3D(rho,T09p1,R,Theta,Phi);  double C19p1 = integrate3D(rho,T19p1,R,Theta,Phi);  double C29p1 = integrate3D(rho,T29p1,R,Theta,Phi);
  double C09p2 = integrate3D(rho,T09p2,R,Theta,Phi);  double C19p2 = integrate3D(rho,T19p2,R,Theta,Phi);  double C29p2 = integrate3D(rho,T29p2,R,Theta,Phi);
  double C09p3 = integrate3D(rho,T09p3,R,Theta,Phi);  double C19p3 = integrate3D(rho,T19p3,R,Theta,Phi);  double C29p3 = integrate3D(rho,T29p3,R,Theta,Phi);
  double C09p4 = integrate3D(rho,T09p4,R,Theta,Phi);  double C19p4 = integrate3D(rho,T19p4,R,Theta,Phi);  double C29p4 = integrate3D(rho,T29p4,R,Theta,Phi);
  double C09p5 = integrate3D(rho,T09p5,R,Theta,Phi);  double C19p5 = integrate3D(rho,T19p5,R,Theta,Phi);  double C29p5 = integrate3D(rho,T29p5,R,Theta,Phi);
  double C09p6 = integrate3D(rho,T09p6,R,Theta,Phi);  double C19p6 = integrate3D(rho,T19p6,R,Theta,Phi);  double C29p6 = integrate3D(rho,T29p6,R,Theta,Phi);
  double C09p7 = integrate3D(rho,T09p7,R,Theta,Phi);  double C19p7 = integrate3D(rho,T19p7,R,Theta,Phi);  double C29p7 = integrate3D(rho,T29p7,R,Theta,Phi);
  double C09p8 = integrate3D(rho,T09p8,R,Theta,Phi);  double C19p8 = integrate3D(rho,T19p8,R,Theta,Phi);  double C29p8 = integrate3D(rho,T29p8,R,Theta,Phi);
  double C09p9 = integrate3D(rho,T09p9,R,Theta,Phi);  double C19p9 = integrate3D(rho,T19p9,R,Theta,Phi);  double C29p9 = integrate3D(rho,T29p9,R,Theta,Phi);
